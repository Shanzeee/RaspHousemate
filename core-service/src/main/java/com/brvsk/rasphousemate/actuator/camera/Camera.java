...
//sourcecode: https://github.com/Pi4J/pi4j-example-components/blob/main/src/main/java/com/pi4j/catalog/components/Camera.java
public class Camera{
    ...
    public static class PicConfig {
        ...
        public static class Builder{
            ...
            int height;
            int quality;
            PicEncoding encoding;
            boolean disablePreview;
            boolean allowFullscreenPreview;
